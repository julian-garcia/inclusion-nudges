...
const Blog = ({pageContext, location}) => {
  ...
  return (
    <Layout siteTitle={`THE INCLUSION NUDGES BLOG<br/><span class="blog-subtitle">Let’s make inclusion the norm</span><span class="blog-subtitle">- everywhere, for&nbsp;everyone,&nbsp;by&nbsp;everyone!</span>`} alignment='center'>
