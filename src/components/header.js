...
import NudgesImg from "../images/nudges.jpg"
...
const Header = ({ siteTitle }) => (
  <header className="header">
    <div className="header-title-container">
      ...
      <h1 className="site-title site-title--bottom">We are people worldwide<br className="desktop-only"/> nudging to make inclusion the default and norm</h1>
    </div>
