...
const Header = ({ siteTitle }) => (
  <header className="header">
    <div className="header-title-container">
      <h1 className="site-title site-title--top">We are people worldwide</h1>
      <h1 className="site-title site-title--bottom">nudging to make inclusion the default and norm</h1>
    </div>
