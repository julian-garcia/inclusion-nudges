...
const ModalSignup = ({signupType}) => (
  <Modal modalClass={`modal-signup modal-signup-${signupType}`}>
    ...
    <form className="modal-form">
      ...
      {signupType === 'blog' &&
      <>
      <label htmlFor={`gdprSignup${signupType}`} className="modal-form__label gdpr">Opt in to allow us<br/> to send you blog updates 
