...
const Footer = () => (
  <footer className="footer row-auto">
    ...
    <div>
      ...
      <p style={{fontSize: '14px', lineHeight: '14px'}}>Creative Commons License<br />The Inclusion Nudges Initative and Guidebook is licensed under the Creative Commons 4.0 International License. This means you can use the material when you share back and don’t use it for commercial purposes.</p>
