  ...
  <>
    <Modal modalClass="modal-download">
      ...
      <form className="modal-form">
        ...
        <button className="modal-form__button" onClick={_signup} type="button">Send me a free taster</button>
      </form>
    </Modal>
    <Modal modalClass="modal-download-confirm">
      ...
      <div style={{textAlign:'center'}} className="modal-social-icons">
        ...
        <FontAwesomeIcon icon={faLinkedinIn} className="modal-social-icon apply-link-style" onClick={(e) => socialShare('https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Finclusion-nudges.netlify.com%2F')} />
      </div>
    </Modal>
  </>
  )
