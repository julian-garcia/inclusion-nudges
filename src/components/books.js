  ...
  <>
    ...
    <div className="row-auto centered footer-bg desktop-m-up">
      <Link to="quick-guide" style={{margin:'1rem 0'}}>
        <h2 className="colour-accent-2" style={{fontWeight:'normal'}}>Quick introduction<br/><span class="colour-black">FOR ALL PEOPLE</span></h2>
      ...
      <div onClick={() => showModal('modal-purchase')} role="button" style={{cursor:'pointer',margin:'1rem 0'}} onKeyPress={() => {}} tabIndex="0">
        <h2 className="colour-accent-1" style={{fontWeight:'normal'}}>100 Inclusion Nudges<br/><span class="colour-black">FOR CHANGE MAKERS</span></h2>
      ...
      <Link to="#" style={{margin:'1rem 0'}}>
        <h2 className="colour-accent-4" style={{fontWeight:'normal'}}>30 Actions<br/><span class="colour-black">FOR LEADERS</span></h2>
        <img src={LeaderImg} alt="" style={{height:'350px', paddingRight:'30px'}} />
        <h3 className="colour-accent-4">Order now</h3>
      </Link>
      <Link to="#" style={{margin:'1rem 0'}}>
        <h2 className="colour-accent-4" style={{fontWeight:'normal'}}>30 Actions<br/><span class="colour-black">FOR TALENT SELECTION</span></h2>
        <img src={TalentImg} alt="" style={{height:'350px', paddingRight:'30px'}} />
        <h3 className="colour-accent-4">Pre-order now</h3>
      </Link>
      <Link to="#" style={{margin:'1rem 0'}}>
        <h2 className="colour-accent-4" style={{fontWeight:'normal'}}>30 Actions<br/><span class="colour-black">FOR MOTIVATING ALLIES</span></h2>
