...
const Books = () => (
  <>
    <h2 className="page-heading" style={{ padding: "1rem 0" }}>
      How you make it happen now
    </h2>
    <div className="centered footer-bg books">
      <h2
        className="page-heading books__title"
        style={{ gridColumn: "1 / span 2", marginBottom: "0" }}
      >
        THE INCLUSION NUDGES GUIDEBOOK
      </h2>
      <Link
        to="/blog/about-inclusion-nudges/power-of-inclusion-nudges"
        className="book"
      >
        <h2
          className="colour-accent-2 book__title"
          style={{ fontWeight: "normal" }}
        >
          Quick introduction
          <br />
          <span className="colour-black book__subtitle">FOR ALL PEOPLE</span>
        </h2>
        <img src={QuickGuideImg} className="book__image quick" alt="" />
        <h3 className="colour-accent-2">
          Read free
          <br />
          Quick Guide
        </h3>
      ...
      >
        <h2
          className="colour-accent-1 book__title"
          style={{ fontWeight: "normal" }}
          id="books"
        >
          100 Inclusion Nudges
          <br />
          <span className="colour-black book__subtitle">FOR CHANGE MAKERS</span>
        </h2>
        <img
          src={GuideFrontImg}
      ...
      <h2
        className="page-heading books__title"
        style={{ gridColumn: "3 / span 3", marginBottom: "0" }}
      >
        ACTION GUIDE SERIES
      </h2>
      <div
      ...
      >
        <h2
          className="colour-accent-4 book__title"
          style={{ fontWeight: "normal" }}
        >
          30 Actions
          <br />
          <span className="colour-black book__subtitle">FOR LEADERS</span>
        </h2>
      ...
      >
        ...
        >
          30 Actions
          <br />
          <span className="colour-black book__subtitle">
