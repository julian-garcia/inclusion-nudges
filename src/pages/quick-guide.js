...
const QuickGuidePage = () => (
  <Layout>
    <SEO title="Inclusion Nudges Quick Guide" description="The Inclusion Nudges Guidebook, 3rd edition, by Lisa Kepinski & Tinna C. Nielsen, is your go to resource with over 100 how-to examples that are based on behavioural science" />
    ...
    <div className="blog-post">
      ...
      <p style={{textAlign:'center'}}><strong>Go to the Inclusion Nudges website to learn more<br className="tablet-up"/> and see how you can purchase your copy of the <br className="tablet-up" />Inclusion&nbsp;Nudges&nbsp;Guidebook.<br/><Link to="/">www.inclusion-nudges.org</Link></strong></p>
