...
const QuickGuidePage = () => (
  <Layout>
    <SEO title="Inclusion Nudges Quick Guide: Why, What, How" description="The Inclusion Nudges Guidebook, 3rd edition, by Lisa Kepinski & Tinna C. Nielsen, is your go to resource with over 100 how-to examples that are based on behavioural science" />
    <div className="accent-2 no-print">
      <h2 className="text no-print">Inclusion Nudges Quick Guide: Why, What, How</h2>
    </div>
